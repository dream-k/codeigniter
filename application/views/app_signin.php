                    ...
                    <form class="form-horizontal auth-form my-4" id="regForm"  action="index.php">
                        ...
                        <div class="tab" id="tab1" style="display:block;">
                            <div class="auth-logo-box">
                                <a href="<?php echo base_url();?>" class="logo logo-admin"><img src="<?php echo base_url('images/signin_images/signin_image_one.png')?>" height="70" alt="logo" class="auth-logo"></a>
                            </div><!--end auth-logo-box-->
                            <div class="text-center auth-logo-text mb-5">
                                <h4 class="mt-0 mb-5 mt-5">Launch Your Vistor App</h4>
                        ...
                        <div class="tab" id="matchcode">
                            <div class="auth-logo-box">
                                <a href="<?php echo base_url();?>" class="logo logo-admin"><img src="<?php echo base_url('images/signin_images/signin_image_two.png');?>" height="70" alt="logo" class="auth-logo"></a>
                            </div><!--end auth-logo-box-->
                        ...
                        <div class="tab" id="congratulation">
                            <div class="auth-logo-box">
                                <a href="<?php echo base_url();?>" class="logo logo-admin"><img src="<?php echo base_url('images/signin_images/signin_image_three.png');?>" height="70" alt="logo" class="auth-logo"></a>
                            </div><!--end auth-logo-box-->
                            <div class="text-center auth-logo-text">
                                <h2 class="mt-0 mb-5 mt-5" style="color:green">Welcome</h2>
                                <h3 class="mt-0 mb-5 mt-5" id="companyName"></h3>
                                <p class="text-muted mb-0" style="width:80%;margin:auto;">You are now being directed to your Visitor web app...
                                </p>  
                            </div> <!--end auth-logo-text-->  
                        </div>
...
function sendSMS(){
    $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>app_signin/sendSMS", 
            data: {
                emp_email: $("#email").val()
            },
            dataType: "json",  
...
$('#email').keyup(function(){
    ...
    if(validateEmail(email)){
        $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>app_signin/email_registered", 
                data: {
                    emp_email: $("#email").val()
                },
                dataType: "json",  
...
$('#nextBtn1').on('click',function(){
    ...
    $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>app_signin/match_password", 
            data: {
                emp_email: $("#email").val(),
            ...
            success: function(data){
                if(data==1){
                    ...
                    $.ajax({
                            type: "POST",
                            url: "<?php echo base_url();?>app_signin/get_user", 
                            data: {
                                emp_email:$('#email').val()
                            },
                            dataType: "json",  
